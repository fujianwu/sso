...
async def http_exception_handler(request: Request, exc: HTTPException):
    ...
    if exc.status_code == 403:
        ...
        return templates.TemplateResponse(request=request, name="403.html", context=context, status_code=403)
...
async def mfa_setup_page(request: Request, current_user: dict = Depends(require_login)):
    ...
    return templates.TemplateResponse(request=request, name="mfa/settings.html", context=context)
...
async def mfa_verify_page(
    ...
    return templates.TemplateResponse(request=request, name="mfa/verify.html", context=context)
...
async def switch_account_page(request: Request, current_user: Optional[dict] = Depends(get_current_user)):
    ...
    return templates.TemplateResponse(request=request, name="account_switcher.html", context=context)
...
async def admin_apps_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_apps.html", context=context)
...
async def admin_fields_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_fields.html", context=context)
...
async def admin_config_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_config.html", context=context)
...
async def docs_page(request: Request, current_user: Optional[dict] = Depends(get_current_user)):
    """开发文档页面"""
    context = {"request": request, "config": config, "current_user": current_user}
    return templates.TemplateResponse(request=request, name="docs.html", context=context)

@app.get("/api", name="api_page")
async def api_page(request: Request, current_user: Optional[dict] = Depends(get_current_user)):
    """API 参考页面"""
    context = {"request": request, "config": config, "current_user": current_user}
    return templates.TemplateResponse(request=request, name="api.html", context=context)
...
async def support_page(request: Request, current_user: Optional[dict] = Depends(get_current_user)):
    """技术支持页面"""
    context = {"request": request, "config": config, "current_user": current_user}
    return templates.TemplateResponse(request=request, name="support.html", context=context)
...
async def admin_inbox_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    _ensure_msg_tables()
    return templates.TemplateResponse(request=request, name="admin_inbox.html", context={
        "request": request,
        "current_user": current_user,
    })
...
async def admin_messages_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_messages.html", context=context)
...
async def admin_audit_logs_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_audit_logs.html", context=context)
...
async def admin_portal_tokens_page(request: Request, current_user: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin_portal_tokens.html", context=context)
